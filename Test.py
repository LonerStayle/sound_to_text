...
AUDIO_PATH = "/Users/seobi/Documents/2025년8월8일3시수업.m4a"      # 여기에 m4a 경로
OUT_BASENAME = Path(AUDIO_PATH).with_suffix("")  # 확장자 제거한 경로

# 모델 크기: tiny / base / small / medium / large-v3
# 한국어면 small~medium 이상 권장, 정확도는 large-v3가 최고
model = WhisperModel("large-v3", "cpu", compute_type="int8")  
